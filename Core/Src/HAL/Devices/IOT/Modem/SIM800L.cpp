				 ...
				 const std::shared_ptr<HAL::DebugController::DebugController> &debug_controller) : ModemInterface(uart_communication, debug_controller) 
{
	...
	generic_at_config.receive_callback = [this](const std::string &msg){return GenericCmdResponse(msg);};
...
bool SIM800LModem::GenericCmdResponse(const std::string &response)
{	
